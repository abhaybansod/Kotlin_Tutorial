...
class FragmentActivityLifeCycleCombinedActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fragment_life_cycle_combined)
        Toast.makeText(applicationContext,"onCreateView in Fragment was Called",Toast.LENGTH_SHORT).show();
    }
